...
static constexpr std::array<std::string_view, 74> kSDXLClipMergeChunks{{
R"SDXL000(#version: 0.2
i n
t h
a n
r e
...
static constexpr char kSDXLClipMergesSha256[] = "9fd691f7c8039210e0fced15865466c65820d09b63988b0174bfe25de299051a";

} // namespace

std::string_view sdxl_clip_merges() {
    static const std::string data = [] {
        std::string value;
        value.reserve(524619U);
        for (const std::string_view chunk : kSDXLClipMergeChunks) value.append(chunk);
        return value;
    }();
    return data;
}

std::string_view sdxl_clip_merges_sha256() noexcept {
    return kSDXLClipMergesSha256;
}
